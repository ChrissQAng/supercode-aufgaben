...
div.innerHTML = "<p>Zufälliges Bild mit JavaScript anzeigen</p>";
div.innerHTML += `<input id="btn" type="button" value="Click me" />`;
div.innerHTML += '<div id="div2"></div>';
...
button.addEventListener("click", () => {
  ...
  div.lastChild.innerHTML = `
        <img class="hi" src="${data[randomIndex].download_url}" alt="random picture">`;
});
