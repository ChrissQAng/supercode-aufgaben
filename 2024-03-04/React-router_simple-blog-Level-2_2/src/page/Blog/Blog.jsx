...
const Blog = () => {
  ...
  return (
    <div>
      ...
      <div className="blog">
        <Article content={blogData[0]} />
        <Article content={blogData[1]} />
        <Article content={blogData[2]} />
        <Article content={blogData[3]} />
        <Article content={blogData[4]} />
        <Article content={blogData[5]} />
      </div>
    </div>
  );
};
